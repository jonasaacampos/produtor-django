...
from .views import dashboard, generate_bar_chart_farms_per_state, generate_pie_chart_farms_per_state, home, generate_pie_chart_culturas, generate_pie_chart_solo_usage
...
urlpatterns = [
    ...
    path("generate_pie_chart_farms_per_state/", generate_pie_chart_farms_per_state, name="generate_pie_chart_farms_per_state"),
